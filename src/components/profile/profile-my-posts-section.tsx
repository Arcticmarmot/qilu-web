    ...
    >
      <Link href={`/posts/me/${post.id}`} className="block">
        <div
          className={cx(
            "bg-gradient-to-br",
            bannerHeights[(post.id + index) % bannerHeights.length],
      ...
      <div className="flex flex-1 flex-col p-4">
        <Link href={`/posts/me/${post.id}`} className="block">
          ...
          <p
            className={cx(
              "mt-2 break-words text-sm leading-6 text-muted",
              previewLines[(post.id + index) % previewLines.length],
            )}
          >
            {preview}
          </p>
  ...
  return (
    <section className="min-w-0">
      ...
      {isLoadingPosts ? (
        ...
        <>
          <div className="columns-1 gap-4 xl:columns-2 2xl:columns-3 [&>*]:mb-4">
